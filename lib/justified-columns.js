        ...
        columns.forEach(function(column, colIndex) {
            if (column.height < referenceColumn || (self.shrink && column.height > referenceColumn)) {
                ...
                column.items.forEach(function(gridItem, itemIndex) {
                    ...
                    if (stretchable) {
                        var stretchableDelta = (gridItem.stretchableHeight * stretchablePercent) / column.totalImagesHeight,
                        ...
                        if (stretchable.nodeName !== 'IMG') {
                            ...
                            newHeight = Math.floor(newHeight); //IE can't do subpixel math properly
